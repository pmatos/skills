...
**1c. Local head — not per-remote.** When 1a produced no record, and 1b
produced no records at all or every record it produced was dropped in Step 3 (each fetch failed and
